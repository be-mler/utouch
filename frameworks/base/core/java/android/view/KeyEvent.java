...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_SOFT_SLEEP = 276;
     ...
     /** Key code constant: Fp right swipe.
     * Swipe right at fingerprint is recognized */
    public static final int KEYCODE_FP_RIGHT_SWIPE = 277;

    /** Key code constant: Fp left swipe.
     * Swipe left at fingerprint is recognized */
    public static final int KEYCODE_FP_LEFT_SWIPE = 278;

    private static final int LAST_KEYCODE = KEYCODE_FP_LEFT_SWIPE;
    ...
    public static final boolean isSystemKey(int keyCode) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_MEDIA_AUDIO_TRACK:
                /** Zuk Special Keycodes to get gestures from Fingerprint*/
            case KeyEvent.KEYCODE_FP_RIGHT_SWIPE:
            case KeyEvent.KEYCODE_FP_LEFT_SWIPE:
                return true;
        }
