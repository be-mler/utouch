...
public final class CMSettings {
    ...
    public static final class System extends Settings.NameValueTable {
        ...
        /**
         * Action to perform when the home key is long-pressed.
         * (Default can be configured via config_pressOnHomeBehavior)
         * 0 - Nothing
         * 1 - Menu
         * 2 - App-switch
         * 3 - Search
         ...
         * 8 - Last app
         */
        public static final String KEY_HOME_PRESS_ACTION = "key_home_press_action";

        /**
         * Action to perform when the home key is long-pressed.
         * (Default can be configured via config_pressOnBackBehavior)
         * 0 - Nothing
         * 1 - Menu
         * 2 - App-switch
         * 3 - Search
         ...
         * 8 - Last app
         */
        public static final String KEY_BACK_PRESS_ACTION = "key_back_press_action";
        ...
        /**
         * Action to perform when on the fingerprint was swiped right U-Touch
         * (Default can be configured via config_fpRightSwipe)
         * (See KEY_HOME_LONG_PRESS_ACTION for valid values)
         */
        public static final String KEY_FP_RIGHT_SWIPE_ACTION = "key_fp_right_swipe_action";

        /**
         * Action to perform when on the fingerprint was swiped left U-Touch
         * (Default can be configured via config_fpLeftSwipe)
         * (See KEY_HOME_LONG_PRESS_ACTION for valid values)
         */
        public static final String KEY_FP_LEFT_SWIPE_ACTION = "key_fp_left_swipe_action";
        ...
        /** @hide */
        public static final Validator KEY_FP_RIGHT_SWIPE_ACTION_VALIDATOR =
                new InclusiveIntegerRangeValidator(0, 8);

        /** @hide */
        public static final Validator KEY_FP_LEFT_SWIPE_ACTION_VALIDATOR =
                new InclusiveIntegerRangeValidator(0, 8);
        ...
        static {
            ...
            VALIDATORS.put(KEY_FP_RIGHT_SWIPE_ACTION, KEY_FP_RIGHT_SWIPE_ACTION_VALIDATOR);
            VALIDATORS.put(KEY_FP_LEFT_SWIPE_ACTION, KEY_FP_LEFT_SWIPE_ACTION_VALIDATOR);
